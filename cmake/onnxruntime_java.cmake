...
if(APPLE)
	...
	if(ONNXRUNTIME4J_OSX_ARCH)
		if(ONNXRUNTIME4J_OSX_ARCH_LEN LESS_EQUAL 1)
			list(GET ONNXRUNTIME4J_OSX_ARCH 1 JNI_ARCH)
...
elseif (WIN32)
    ...
    elseif(${onnxruntime_target_platform} STREQUAL "x64")
      ...
      message(FATAL_ERROR "ONNX Runtime Java extension is currently not supported on Windows ${CMAKE_HOST_SYSTEM_PROCESSOR} architecture")
	endif()
else()
  set(JNI_ARCH ${CMAKE_HOST_SYSTEM_PROCESSOR})
  message("Set Java ARCH TO ${JNI_ARCH}")
endif()
